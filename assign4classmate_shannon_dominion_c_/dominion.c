...
void adventurerEffect(int drawntreasure, struct gameState *state, int currentPlayer, int *temphand, int z){
...
void feastEffect(struct gameState *state, int currentPlayer, int choice1, int *temphand){
...
void cutpurseEffect(int currentPlayer, struct gameState *state, int handPos){
	int i, j, k;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case feast:
		feastEffect(state, currentPlayer, choice1, temphand);	
		return 0;
